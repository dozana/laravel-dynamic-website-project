                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mb-4">Edit Blog Category Page</h4>
                            ...
                            <form method="post" action="{{ route('update.blog.category', $blog_category->id) }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_category" id="blog_category" class="form-control" type="text" value="{{ $blog_category->blog_category }}">
                                        @error('blog_category')

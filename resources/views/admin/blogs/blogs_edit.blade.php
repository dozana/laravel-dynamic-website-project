                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.blog', $blogs->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_title" id="blog_title" class="form-control" type="text" value="{{ $blogs->blog_title }}">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-md mb-3" src="{{ asset($blogs->blog_image)  }}" alt="">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="blog_tags" value="{{ $blogs->blog_tags }}" id="blog_tags" class="form-control" type="text" data-role="tagsinput">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="blog_description" id="elm1" class="form-control" rows="5">{{ $blogs->blog_description }}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
